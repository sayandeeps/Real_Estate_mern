...
const Clients = () => {
 ...
 const { darkMode, toggleDarkMode } = useDarkMode();
  return (
    ...
    font-semibold leading-10'>What are our clients <br></br> saying about us</h1>
    </div>
    ...
    <div id='clients-box' className='grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8 w-full'>
    {
      client.map((item, index)=>(
        ...
        className='bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col
        justify-center items-center gap-6 rounded-xl w-full'>
